...
function Logo() {
  return (
    <a href="#top" className="font-display text-[19px] font-bold tracking-tight">
...
export function Navigation() {
  ...
  return (
    <header
      id="top"
      className="sticky top-0 z-50 border-b border-grid/70 bg-bg/80 backdrop-blur-md"
    >
          ...
          >
            <div className="flex flex-col gap-1 px-5 py-4">
              ...
              <div className="mt-2 flex items-center justify-between border-t border-grid pt-4">
                <LanguageSwitcher />
                <a href={APP_URL} className="text-[14px] font-medium text-cyan">
                  {t("login")}
                </a>
              </div>
              <a
