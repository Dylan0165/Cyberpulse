...
import {
  ...
  Settings, HelpCircle, Sparkles, GitCompare, Database,
} from "lucide-react";
...
const NAV_SECTIONS = [
  ...
  },
  {
    title: "EXTRA MODULES",
    items: [
      { name: "Scan Vergelijking", href: "/compare",         icon: GitCompare },
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-5 py-5" style={{ borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="flex h-8 w-8 items-center justify-center rounded-lg" style={{ background: "#0071e3" }}>
      ...
      <div className="px-3 pb-4 space-y-1" style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: "12px" }}>
        ...
        <div className="flex items-center gap-2 px-3 py-2">
          <span className="h-2 w-2 rounded-full flex-shrink-0" style={{
            background: kaliOnline === null ? "#ff9500" : kaliOnline ? "#34c759" : "#ff3b30",
            boxShadow: kaliOnline ? "0 0 6px rgba(52,199,89,0.5)" : undefined,
          }} />
          <div className="min-w-0">
            ...
            {kaliVm && kaliOnline && (
              <p className="text-[10px] truncate font-mono" style={{ color: "rgba(245,245,247,0.3)" }}>
                {kaliVm}
              </p>
            )}
          </div>
